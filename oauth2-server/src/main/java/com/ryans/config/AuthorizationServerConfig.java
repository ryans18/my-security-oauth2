...
/**
 * Author：Ryans
 * Date：Created in 2023/9/27 23:23
 * Introduction：授权策略配置
 */
@Configuration
public class AuthorizationServerConfig {
    ...
    public RegisteredClientRepository registeredClientRepository(JdbcTemplate jdbcTemplate) {
        ...
        JdbcRegisteredClientRepository jdbcRegisteredClientRepository = new JdbcRegisteredClientRepository(jdbcTemplate);
         ...
         client_secret：密码
         */
         String client = "sso_client";
//         String client = "my_client";
         // 查询客户端是否存在
        RegisteredClient registeredClient = jdbcRegisteredClientRepository.findByClientId(client);

        // ---------- 2、添加客户端
        // 数据库中没有的话
        if (registeredClient == null) {
            registeredClient = createRegisteredClient(client);
    ...
    private RegisteredClient   createRegisteredClient(String clientId) {
        ...
        return RegisteredClient
                 ...
                 */
                .redirectUri("http://127.0.0.1:8080/login/oauth2/code/sso_client")
...
*/
     ...
     * 在生产中这个地方应该配置为域名
     * @return  ProviderSettings to AuthorizationServerSettings
     */
    @Bean
